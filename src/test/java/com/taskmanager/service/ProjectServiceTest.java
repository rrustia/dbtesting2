...
class ProjectServiceTest {
    ...
    /**
     * Confirms that a project keeps the same name while accepting a new description.
     * Input: mocked repository data and an update request with the original name.
     * Output: no return value; assertions verify the updated response fields.
     */
    @Test
